...
static int8_t func_14(    )
{
    if ((g_571 <= 2063719605))
                    ...
                    if ((((int16_t)1)))
    {
        if ((!((((void ***)1) < g_792)) || ((g_792 < 1010625201) || (!g_792))) )
{


g_183 |= (((((int8_t)1)) , (-5L)) , g_968);
...
int32_t backup_2_8502_22363_g_183 = (-((((((g_377 && ((int32_t)1)) * g_37) | l_59.f5) & (g_80 ^ ((int64_t)1))) - (~(((~((l_59.f2 * l_59.f0))) / (g_66 & g_38)))))));
if((((!l_59.f5) || (g_183 < backup_2_8502_22363_g_183)) && ((backup_0_8502_91289_l_59_f5 <= 12) && (l_59.f2 >= 26)))){
backup_0_8502_91289_l_59_f5 = l_59.f5;
l_59.f5 = (-(((~((~((~((~(l_59.f2)))))))) / (~(((-(((g_183 + backup_2_8502_22363_g_183) + ((~(l_59.f0)) | (-(((backup_0_8502_91289_l_59_f5 + g_80) / ((int32_t)1)))))))) & (g_377 | (-((g_37 % g_66))))))))));
