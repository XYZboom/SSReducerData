...
static int8_t func_14(  struct S0 p_17  );
static int16_t func_44(uint32_t p_45);
static int64_t func_1()
{
    struct S1 l_2 = {5257,2494,15,7269,192,0,6867};
    l_2.f2 = ((l_2 , (((((((-8L) && (safe_rshift_func_uint8_t_u_u(func_5((((((safe_div_func_uint8_t_u_u( func_14(  g_21  ))) , (*((struct S1*)0))))) , g_571)) ))) != ((int8_t)1)) , 0UL) > ((unsigned int)1)) | 0xC987502CL) && ((uint32_t)1))) != ((int8_t)1));
    }
...
static int8_t func_14(  struct S0 p_17  )
{
    ...
    {
        if (((safe_div_func_uint8_t_u_u( ((int16_t)1))) , ((int32_t)1)))
        {
            if ((((*((struct S0*)0)) , ((((int16_t)1)) <= ((uint16_t)1))) ^ p_17.f0))
            {
...

{
                    ...
                    ((((int32_t)1) | (safe_mod_func_int16_t_s_s(((func_44(((safe_rshift_func_int16_t_s_s((g_183 |= ((unsigned int)1)) )) , (((void ***)1)))) , ((int)1)) | ((((int8_t)1)) <= g_571)) ))) || (-1L));
    }
