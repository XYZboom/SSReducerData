...
int32_t BHbHbdl_2818_f2 = (~((((((~((BHbHbbl_2818_f0 / l_2818.f1))) * (-(l_2818.f2))) << (-((~(l_2818.f0))))) * (((~(((~(g_27.f7)) ^ (~(g_80))))) * l_2818.f3) / g_210.f3)) ^ (~((~((~((-((((int32_t)1) & l_2818.f5))))))))))));
                               if((g_210.f6 && (l_2818.f3 > l_2818.f0))){
BHbHbdl_2818_f2 = l_2818.f2;
l_2818.f6 = (~((((-((~(g_210.f3)))) * (~((-((((~(((int32_t)1))) * (l_2818.f0 * ((uint32_t)1))) * (l_2818.f2 & g_210.f6))))))) ^ (~(((~((BHbHbbl_2818_f0 & (l_2818.f5 & (~(g_27.f7)))))) & BHbHbdl_2818_f2))))));
g_27.f7 = (~(((-(((~(l_2818.f0)) | l_2818.f6))) * (((~((~(((((((uint32_t)1) * BHbHbdl_2818_f2) | g_27.f7) ^ (~(g_210.f3))) * (l_2818.f3 | l_2818.f2)))))) & (-(l_2818.f1))) << BHbHbbl_2818_f0))));
