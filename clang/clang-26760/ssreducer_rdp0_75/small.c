...
{
    if ((g_100<=47))
                    g_120[1] = func_3( (func_10( ((safe_lshift_func_uint16_t_u_u( (func_19() , (((((uint8_t)1) < g_120[1]) != ((int8_t)1)) & ((uint32_t)1))))) , ((int16_t)1)) ) != ((uint32_t)1))   );
                                       }
static int32_t func_3( uint16_t p_5   )
{}
static int16_t func_10( uint8_t p_12 )
...
static int16_t func_25()
{
    g_120[1] = (0x0415L > ((func_28((((uint32_t)1) , (safe_mod_func_int16_t_s_s(func_33( ) ))) ) ^ 5UL) == ((uint32_t)1)));
    }
static int16_t func_28(int32_t p_29 )
{}
static int16_t func_33( )
{
    ...
    for (; (((uint8_t)1) != 4); )
    {
        if ((safe_lshift_func_int16_t_s_u((((int16_t)1) <= ((uint8_t)1)), (((int8_t)1)))))
        {
...
LABEL_4o4og:;
l_1052 = (~((((-(((l_1052 >> l_1081) | (~((~(B4o4ocg_100))))))) ^ (((g_100 * (B4o4oel_790 & (-((~(l_1007)))))) - (((g_694 - B4o4obl_919) ^ l_919) | (~(l_790)))) && (B4o4odl_1369 && (~((l_1433 ^ l_1327)))))) & (~((((uint32_t)1) * (B4o4ol_1052 - l_1369)))))));
if((l_790 < B4o4oel_790)){
l_1052 = (~(((~((((-(l_1007)) - (~((l_1327 << l_919)))) && (-(((((B4o4oel_790 << ((~(l_1369)) << (~((B4o4odl_1369 | g_100))))) & (-((l_1052 & ((uint32_t)1))))) | B4o4ocg_100) << (-((~((((g_694 << l_1433) * l_790) | B4o4ol_1052))))))))))) << ((~(B4o4obl_919)) | (~(l_1081))))));
goto LABEL_4o4og;
}
}
}
