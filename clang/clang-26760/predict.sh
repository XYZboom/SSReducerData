...
TIMEOUTEXE=2
TIMEOUTCCOMP=10
clang_3_6_0="$run_in_docker timeout -s 9 $TIMEOUTCC clang-3.6.0 -w"
...
readonly CFLAG="-o t"
readonly CLANGFC="$clang_7_1_0 -w -m64 -O0 -Wfatal-errors -fwrapv -ftrapv -fsanitize=undefined,address"
