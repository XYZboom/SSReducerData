...
)
{
  if (g_3)
  {
    (safe_lshift_func_int16_t_s_u
       ((0x673E7ED6L > ((!(safe_mul_func_int16_t_s_s (p_7, func_14 ( (((int32_t)1) & (safe_mod_func_uint16_t_u_u ( func_22 ( ))))  )))))) ));
  }
  else
  {
   ...
   )
{
  ...
  {
    if (((func_42 ((((int8_t)1) & func_45 ((((int16_t)1))    )) )) >= 1UL))
    {
      }
    else;
  }
