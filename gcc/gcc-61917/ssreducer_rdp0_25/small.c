...
func_1 ()
{
     ...
     )
  {
    ...
    {
      if ((((((((((uint32_t)1)) || 0xFDL) >= ((volatile uint32_t)1)) & ((uint32_t)1)) < ((((safe_rshift_func_int16_t_s_u (l_2[0], 3)) != ((-1L) <= (((int8_t)1)))) | g_1835[0][3][2]) < ((int16_t)1))) < l_2[g_3]) | g_344))
      {
 for
   (g_588
    =
   ...
   )
{
  ...
  {
    if (((g_71[7] = func_42 ((((int8_t)1) & func_45 ((((int16_t)1)) , g_3, (((int32_t)1) > (((g_71[7] = ((int32_t)1)) >= g_2004[1][0][4]))), g_1810[0])) )) >= 1UL))
    {
      }
    else;
  }
...
for
 ...
 g_71
   [7]
   =
   ((safe_sub_func_int16_t_s_s ((safe_add_func_uint16_t_u_u ((0x02D3L | ((g_2004[0][0][2] = (l_2284 = g_697[8][0])) | (((((uint16_t)1) ^ ((uint32_t)1)) != ((65528UL && (((int8_t)1) < (((((l_2285) || (((uint16_t)1))) == g_1810[0]) == p_50) && g_201))) && 65532UL)) >= p_48))) )) )) > p_50);
 (((safe_mul_func_int8_t_s_s ((safe_lshift_func_uint8_t_u_s ( (safe_add_func_uint8_t_u_u (p_46, ((((g_2004[6][0][8] && ((safe_mod_func_uint32_t_u_u (p_46, l_2307)) || ((((safe_rshift_func_int8_t_s_u ((l_2285 = (safe_mul_func_int16_t_s_s (((safe_rshift_func_int16_t_s_u (((safe_add_func_uint16_t_u_u ((safe_lshift_func_int8_t_s_s (((l_2018 ^ (p_48 == ((!((safe_add_func_uint8_t_u_u ((((((uint8_t)1)) >= g_1265[2][5]) > 0L), 0x7FL)) && ((uint16_t)1))) >= l_2018))) & p_48) )) )) || 4294967288UL), 6)) != 0UL), p_50))) )) >= p_49) == l_2284) == g_1835[0][3][2]))) <= 0x7D15L) >= ((uint32_t)1)) < g_2004[6][0][1]))))) )) && p_50) & ((uint32_t)1));
 }
    };
  }
  }
