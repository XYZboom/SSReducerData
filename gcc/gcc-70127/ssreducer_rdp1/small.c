...
{
    g_2 = g_2;
    (0x3D783989L | func_3((func_8(((safe_add_func_uint16_t_u_u(((safe_unary_minus_func_int16_t_s(((func_14( ((int32_t)1)   ) || 0xA1L) != ((int32_t)1)))) || ((int8_t)1)) ))) ))   ));
}
static int32_t func_3(uint16_t p_4   )
{
    for (; (p_4 < 42); )
...
{
    (0xE8A9B9C2L);
                                       if (((((unsigned int)1)<251) || ((int32_t)1)));
    for (; (((uint32_t)1) < 45); )
    {
