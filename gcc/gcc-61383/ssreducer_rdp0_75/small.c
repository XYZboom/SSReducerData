...
)
{
     ...
     )
  {
    ...
    int32_t
      ...
      =
      0xFB97F931L;
    if ((0x4F92L < (safe_lshift_func_int16_t_s_s ((((p_40 != (safe_lshift_func_uint16_t_u_u ((p_40 != (((((int8_t)1)) | ((safe_add_func_int8_t_s_s (((((l_220 = (safe_mod_func_int8_t_s_s ((((safe_rshift_func_int16_t_s_u ((-2L) )) == 0xC58CL) == p_40), p_40))) == (-3L)) != p_40) ^ p_40) )) >= g_94)) <= (-10L))), l_218))) || 0x282EL) != l_218), 6))))
    {
      if ((0x4F92L < (safe_lshift_func_int16_t_s_s ((((p_40 != (safe_lshift_func_uint16_t_u_u ((p_40 != (((((int8_t)1)) | ((safe_add_func_int8_t_s_s (((((l_220 = (safe_mod_func_int8_t_s_s ((((safe_rshift_func_int16_t_s_u ((-2L) )) == 0xC58CL) == p_40), p_40))) == (-3L)) != p_40) ^ p_40) )) >= g_94)) <= (-10L))), l_218))) || 0x282EL) != l_218), 6))))
    {
      }
   ...
   )
{
  (safe_sub_func_int32_t_s_s
     ((g_94 = (safe_mod_func_uint16_t_u_u ((((int32_t)1) && ((-3L) >= (safe_add_func_int16_t_s_s (((g_7 = ((((int16_t)1)) != 6L)) == 0xB5L) )))) ))) ));
  return
    g_7;
}
int
