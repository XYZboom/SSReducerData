...
static uint8_t func_10(int16_t p_11, int8_t p_12)
{
    ...
    if ((g_897[0][2] = ((int32_t)1)))
    {
        int32_t l_4253 = 0x298E0FB6L;
        l_4253 = ((((safe_sub_func_int32_t_s_s( ((((((safe_mod_func_uint8_t_u_u((((((uint16_t)1)) && 0xD98578FCL) & 1L), (+(((safe_add_func_int32_t_s_s(((((safe_unary_minus_func_int32_t_s((g_897[0][2] = ((((safe_mod_func_int32_t_s_s((safe_add_func_int32_t_s_s((safe_rshift_func_int8_t_s_u((((safe_lshift_func_uint8_t_u_s(((safe_add_func_int16_t_s_s((safe_lshift_func_int8_t_s_u((((g_427[1] = (((int16_t)1))) , p_11) , l_4281[2]), 3)) )) | l_4253), g_27[2][0])) , p_12) && l_4281[2]), 4)), (-10L))), 0x774942A1L)) , l_4281[3]) | 4294967295UL) || 0x3866562AL)))) != 0x91L) , p_12)), p_12)) || 1L) <= ((uint32_t)1))))) <= ((int32_t)1)) >= 0x64BCL) != ((uint8_t)1)) , (-10L)) < p_12))) , 0xF0E3L) | ((int8_t)1)) , p_11);
        }
    else;
    }
