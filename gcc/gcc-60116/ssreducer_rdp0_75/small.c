...
func_1 ()
{
      ...
      for (g_806 = 0; (g_806 <= 3); )
 {
       ...
       if (g_1395)
  {
    ...
    (safe_rshift_func_int16_t_s_s
     (((0x5C91L <
        ((((uint16_t)1)) >= l_4837[4][1][5])) < 0x991BL), l_4787[0]))))));
        g_208[1] =
   ((g_3487 =
   ...
   ((((safe_mul_func_uint8_t_u_u
      ...
      ((((+
          (((((((((g_99[3] =
           ...
           (safe_mul_func_int16_t_s_s
            (((l_4883) &
       (((((((((((uint16_t)1)) > g_280)) > g_280) && ((uint32_t)1)) == 0x0933C1602E5D7963LL)) != g_359) >= g_1395)) ))) >= l_4787[0]) ^ l_4885) | g_56)) > 0x9CL) || g_540[0][0][4]) == l_4787[0])) & 2L) != 0x9F52L) | g_983)) | ((int32_t)1)) | g_897))))) >= g_1394) | ((int8_t)1)) == l_4885);
      }
    else
      {
       ...
       ((g_921[5][7][0] =
         (safe_sub_func_int64_t_s_s
          (0xFE2B8FA57479FD98LL,
           (g_3807 <=
            ((safe_add_func_uint8_t_u_u
       ((((uint32_t)1)) )) | 0x1A6A892DD97E9186LL))))), ((int8_t)1))) >= ((int64_t)1)) != l_5084))))) == ((uint32_t)1)) ));
         return g_983;
       };
     };
