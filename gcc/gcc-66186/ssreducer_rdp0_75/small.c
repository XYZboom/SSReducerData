...
static int32_t func_8(  uint16_t p_11)
{
    (((((safe_lshift_func_int8_t_s_u(func_29(((safe_rshift_func_int8_t_s_u(((((uint8_t)1)) & (safe_div_func_int16_t_s_s((safe_mod_func_uint8_t_u_u((+((g_2 > func_42(g_2 )) | (safe_rshift_func_int16_t_s_s(func_48( ((safe_add_func_uint16_t_u_u(func_55( ((int32_t)1) ) )) || p_11)  ), ((uint16_t)1))))) )), p_11))) )) >= ((const int16_t)1))  ), 5)) && ((int32_t)1)) | ((uint32_t)1)) == 8UL) & ((uint16_t)1));
    return ((int32_t)1);
}
...
static uint16_t func_55( const uint16_t p_57 )
{
    if (g_2)
    {
        if ((((safe_sub_func_int32_t_s_s((((((int8_t)1)) <= (safe_lshift_func_int8_t_s_s((func_75((safe_lshift_func_uint8_t_u_u(((((safe_sub_func_uint32_t_u_u(((func_81(((((safe_add_func_uint16_t_u_u(g_2 )) < (func_89(  p_57  ) && ((int32_t)1))) != ((int32_t)1)) != ((uint32_t)1))) <= p_57) <= 0x25B967A1L) )) < 0UL) != 0x6224ACA1L) ^ g_2), 7))) != ((uint32_t)1)), ((int32_t)1)))) != ((int8_t)1)), 1L)) | ((int8_t)1)) || ((int16_t)1)))
        {
            }
        else;
        }
