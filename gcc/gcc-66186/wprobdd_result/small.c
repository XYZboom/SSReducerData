       ...
       uint16_t func_55(int8_t p_56,       uint16_t p_57, uint32_t p_58)
{
    uint32_t l_72 = 0x30A04A8FL;
       ...
       int16_t func_89(int8_t p_90,       int8_t p_91,       int8_t p_92, uint16_t p_93, int32_t p_94)
{
    int32_t l_103 =  -7L ;
    int8_t l_267 = 0xA3L;
    ...
    return l_267;
       ...
       uint32_t func_97(int32_t p_98, uint16_t p_99, uint16_t p_100, uint32_t p_101, uint16_t p_102)
{
    int16_t l_125[8];
