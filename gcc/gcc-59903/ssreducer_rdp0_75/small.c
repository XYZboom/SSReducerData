...
if (((~func_105( (((safe_div_func_uint32_t_u_u(((((safe_lshift_func_uint8_t_u_s(((uint8_t)1), 2)) | ((uint32_t)1)) < (safe_lshift_func_int16_t_s_s((func_121((g_203[2] = func_124(func_129( l_147, ((uint32_t)1) )   )) )) ))) != l_147.f4) )) | ((uint8_t)1)) | g_4[7][0][1]))) == ((uint32_t)1)))
    {
...
for (p_132 = 0; (p_132 <= 39); ++p_132)
    {
        ...
        for (p_131.f0 = 0; (p_131.f0 <= 2); p_131.f0 += 1)
        {
            ...
            if (((g_23[p_131.f0] < (safe_lshift_func_int16_t_s_u((((l_151.f0 ^ (safe_mod_func_int16_t_s_s(0x58C3L, (safe_sub_func_uint8_t_u_u((((safe_lshift_func_int8_t_s_u( )) <= 4UL) && (p_131.f4 = 0x517BL)) ))))) & (l_164 = ((int8_t)1))) | ((int16_t)1)) ))) ^ l_151.f1))
            {
                ...
                {
                    g_80 = (+((safe_mul_func_int16_t_s_s(((((l_164 ^ ((((int32_t)1) | ((safe_sub_func_uint8_t_u_u((safe_mod_func_int16_t_s_s(((safe_rshift_func_uint16_t_u_u((l_151.f3 ^= g_4[7][0][1]), ((((uint32_t)1) != (((int32_t)1) == (((safe_add_func_uint8_t_u_u((safe_unary_minus_func_uint32_t_u((safe_sub_func_uint32_t_u_u(g_4[7][0][1], (safe_unary_minus_func_int8_t_s(((l_195 = (safe_mul_func_int16_t_s_s((((((safe_lshift_func_uint8_t_u_s((safe_mod_func_int32_t_s_s((g_152[0].f3 |= (((uint16_t)1))), 0xBCA6F5D4L)), 2)) && 0xC7L) && 0xC0AAL) && p_131.f1) | g_23[1]), g_152[0].f4))) != g_23[2]))))))) )) || 255UL) | 1UL))) > g_152[0].f0))) && 0L), l_151.f0)) )) == 0xF4L)) < 0x12L)) ^ ((int32_t)1)) <= ((uint32_t)1)) == (-10L)), (-1L))) < p_131.f1));
