...
static uint32_t func_1()
{
    ...
    g_1018[0][7][6] = (safe_rshift_func_int8_t_s_s((func_4(((((0x7CL < func_6(func_11((((volatile uint16_t)1) & (safe_sub_func_int32_t_s_s(((uint16_t)1), func_17(((safe_mod_func_int16_t_s_s(((g_21[2] ^ func_22( g_21[1])) && 0L), g_21[0])) <= l_1393[1][1]))))))   )) | l_1393[1][1]) ^ l_1393[1][3]) , 0xDC89L)) <= ((uint8_t)1)), 1));
...
static uint8_t func_6(int8_t p_7   )
{
    ...
    if (((((((+(((!((((((int8_t)1) > ((((((uint8_t)1)) <= (l_2429[2] = (((uint8_t)1)))) <= ((uint32_t)1)))) || ((int32_t)1)) , g_1018[0][7][2]) < ((int8_t)1))) , ((int32_t)1)) == ((uint16_t)1))) <= 0x5CC1L) , ((int32_t)1)) && p_7) , p_7) == g_1105))
    {
        ((((int32_t)1) < (((int32_t)1))) != (l_2429[1] > (safe_rshift_func_int16_t_s_u((safe_mod_func_int16_t_s_s((safe_add_func_uint16_t_u_u( (g_221 = ((((((((((uint8_t)1) && ((((uint16_t)1)) == ((uint32_t)1))) == ((p_7 || (((1L >= p_7) <= p_7))) > ((uint8_t)1))) || 0xE7L)) != l_2429[0]) || ((uint32_t)1))) , g_1018[0][7][2])))), g_428)) ))));
    }
    else;
    return l_2429[2];
}
