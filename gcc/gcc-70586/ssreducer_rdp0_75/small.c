    ...
    if (g_540)
    {
                                            ...
                                            for (l_1288 = 0; (l_1288 <= 49); l_1288 = safe_add_func_uint32_t_u_u(l_1288, 8))
        {
            int i, j, k;
            {
                ...
                uint8_t l_1527 = 6UL;
                if ((safe_lshift_func_int8_t_s_u((p_9 && 0xDCE4L), (safe_lshift_func_int8_t_s_u(((l_1424 = (safe_sub_func_uint16_t_u_u((g_315 = (l_27 < ((((((((!(safe_lshift_func_int8_t_s_s((!((safe_add_func_int8_t_s_s((((int32_t)1) > 0xB5EEL), p_9)) || (p_9 && (0xDC53108EL > (safe_unary_minus_func_int16_t_s((((safe_rshift_func_uint16_t_u_s((l_1179 = (safe_mod_func_int32_t_s_s(((safe_add_func_uint16_t_u_u((0x6B50CB0AL | p_9) )) < 0x1DL), 0xBC2AB98CL))) )) == 0x0979578BL) == ((int16_t)1)))))))), l_1359[3])))) == ((uint16_t)1)) == 0UL) && (-10L)) || l_1423) ^ 1UL) < 0xE469L))) ))) ^ 0xAFL), 2)))))
                {
                    }
                else
                {
                    l_1423 = (~(((~((~((~((((~(((uint16_t)1))) % (~(l_1434))) + l_1424))))))) / (~((((((int32_t)1) && l_1423) >> (~((~(g_173))))) & (((((((uint32_t)1) && ((int8_t)1)) + (~(((uint16_t)1)))) - ((uint8_t)1)) ^ ((((int16_t)1) - l_26) - g_1129)) || (((int16_t)1) % (((int16_t)1) | ((int16_t)1))))))))));
if((!g_538)){
printf("l_1179=%lld\n", (long long)l_1179);
}
if((!g_1129)){
